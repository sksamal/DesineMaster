...
class TopologyFactory
{
    ...
    typedef struct
    {
        int source;
        int destination;
	int isHost = 0;   // is it a host or another node ??
    } NodePair;
...
//------------------------------------------------------------------------------
	...
	RandomVar* hlink_capacity = (RandomVar*) 0);
...
//------------------------------------------------------------------------------
//  Topology* createTopologyFatTree(description);
//  Creates the new Topology using FatTree model
//  Input : the description of for the new topology:
//  description = "FatTree","<levels>","[<directed>]"
//    when <directed> is omitted, the topology is undirected.
//------------------------------------------------------------------------------
